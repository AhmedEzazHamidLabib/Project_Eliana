...
This software (“Eliana”) is provided **solely** for:

- personal evaluation  
- academic admissions review  
- portfolio demonstration  

It is **not open-source**, and no rights are granted except those explicitly stated here.

The intent of this repository is to demonstrate **system architecture, design philosophy, and engineering capability** — **not** to provide a functional, reproducible, or deployable software product.

This repository **intentionally excludes** all proprietary assets required for full functionality, including:
...
a. download the source code solely for **private inspection**;  
b. view and inspect the source code in its **unmodified** form;  
c. execute the code **exactly as provided**, without modification, on your own local machine.

These permissions exist only for:
...
a. using the software for any **commercial**, **institutional**, **organizational**, or **production** purpose;  
b. modifying, adapting, translating, patching, or creating **derivative works**;  
c. distributing, publishing, uploading, sublicensing, or sharing any part of the software;  
d. reverse engineering, decompiling, analyzing internal logic, or attempting to reconstruct **missing datasets, embeddings, or model weights**;  
e. using any component to train, fine-tune, evaluate, or develop **any machine learning or AI system**;  
f. incorporating any part of this code into machine learning **training datasets**;  
...
This license may be revoked **at any time**, with or without cause.

Upon revocation, you must immediately delete **all copies** of the software in your possession, including:
...
All risks arising from its use remain solely with the user.

The author and Tiferet Labs assume **no liability** for any damages arising from:
...
### **OpenAI GPT-4o**  
Used as the **current execution backend** via API.  
No weights are redistributed or modified.  
GPT-4o is a trademark of OpenAI. All rights belong to OpenAI.

### **Qwen 2.5–14B (Apache 2.0 License)**  
Used only for **private fine-tuning** experiments to replicate Eliana’s personality layer.  
Not redistributed in this repository.  
Acknowledged under the terms of Apache 2.0.
